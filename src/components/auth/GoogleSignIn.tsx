  ...
  return (
    <div className="w-full">
      <button
        ...
        disabled={isLoading}
        className="w-full bg-white text-[#1b1b1c] text-sm py-3 px-4 rounded-full shadow-sm flex items-center justify-center gap-3 transition-colors duration-200 ease-out hover:bg-[#f6f3f4] active:bg-[#f0edee] border border-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
      >
